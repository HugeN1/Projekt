...
public class Main extends Application {
    ...
    private static final int iloscPar = 8;
    private static final int liczbaWierszy = 4;
        ...
        public Karta(String wartość){
            ...
            setOnMouseClicked(event ->
            {
                ...
                if (wybrany == null){
                    ...
                    otwarte(()->{if(!taSamaWartosc(wybrany)){
                        wybrany.zamknięte();
                        this.zamknięte();
                    }
                    else{
